<template>
  <zig-zag-line
    ...
    :stroke="'#07bf13'"
    :height="$vuetify.display.mobile ? 7 : 10"
  />
  <div
    class="app-padding portfolio-section"
    id="portfolio"
    :style="style"
  ...
  >
    <v-row
      ...
      justify="center"
      no-gutters
      :class="$vuetify.display.mobile ? 'py-15 mt-15' : 'py-15 my-15'"
    >
      <v-col
        sm="6"
        cols="12"
        class="justify-center"
        :class="getClassName(0)"
      ...
      <v-col
        ...
        cols="12"
        class="text-stroke-1"
        :class="$vuetify.display.mobile ? '' : 'pl-6 py-6'"
      >
      ...
      <v-col
        ...
        cols="12"
        class="justify-center"
        v-for="(project, i) in $vuetify.display.mobile
          ? project_list
          : project_list.splice(1, 10)"
        :key="i"
...
export default {
    ...
    return {
      ...
      project_list: [
        ...
        },
        {
          ...
          image: require("@/assets/images/projects/indianmentors.png"),
        ...
        },
        {
          ...
          title: "Spider Tech",
          image: require("@/assets/images/projects/spidertech.png"),
  ...
  mounted() {
    this.style = {
      backgroundImage:
        "url(" + require("@/assets/images/dark/yellow-semi-circle.svg") + ")",
    };
  },
  methods: {
    getClassName(i) {
      ...
      if (this.$vuetify.display.mobile) {
        ...
        if (i == 6) class_name += " px-0 py-6";
        else if (i % 2 == 0) class_name += " pr-6 py-6";
        else class_name += " pl-6 py-6";
      }
      return class_name;
    },
  },
