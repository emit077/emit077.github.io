                    ...
                    <Card className="bg-background card-hover">
                        <CardContent className="p-8 md:p-12">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                                <div className="group">
                                    <h4 className="text-4xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform">5+</h4>
                                    <p className="text-muted-foreground font-medium">Years Experience</p>
                                </div>
                                <div className="group">
                                    <h4 className="text-4xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform">20+</h4>
                                    <p className="text-muted-foreground font-medium">Technologies Mastered</p>
                                </div>
                                <div className="group">
                                    <h4 className="text-4xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform">50+</h4>
                                    <p className="text-muted-foreground font-medium">Projects Completed</p>
                                </div>
                                <div className="group">
                                    <h4 className="text-4xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform">24/7</h4>
                                    <p className="text-muted-foreground font-medium">Always Learning</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
