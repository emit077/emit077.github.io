...
import OctaLogo from "@/components/other-components/OctaLogo";
...
export default {
  ...
  mounted() {
    ...
    APP_BAR.style.height = this.$vuetify.display.mobile ? "100px" : "130px";
        ...
        if (document.scrollingElement.scrollTop) {
          if (this.$vuetify.display.mobile)
            APP_BAR.style.height =
              document.scrollingElement.scrollTop < 50 ? "60px" : "60px";
          else
            APP_BAR.style.height =
              document.scrollingElement.scrollTop < 50 ? "130px" : "90px";
